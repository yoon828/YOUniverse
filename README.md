...
## 텍스트를 음성으로 변환
시각 장애인을 위한 음성 서비스는 TTS API를 활용하여 다른 사용자의 텍스트 입력을 음성으로 모두 변환하여 들려줍니다 (음성 서비스이기 때문에 시연 영상을 참고해주세요🙂)

또한 마이크로 대화가 불가능한 사람들은 화면 하단, 중앙에 위치한 입력 창을 통해 키보드로 대화 입력이 가능합니다.
...
## 5. 고려사항
## 식별 아이콘 
![image](/uploads/9f080b065e45d254e3d3ac35ee69decd/image.png)
...
로그 창 하단에 있는 글씨 크기 축소, 확대 버튼을 사용해서 로그창에서 로그 글씨 크기를 조절할 수 있습니다.
...
## 색상 선정
![image](/uploads/8ea734a46619a14893a71fa527bc0183/image.png)
